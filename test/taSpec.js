...
describe("ta.js", function() {
  ...
  describe("TA([1, 2, 3, 1]).ma(2)", function() {
  ...
  describe("TA([9, 1, 2, 3, 1, 9]).ma(2, 1, 5)", function() {
  ...
  describe("TA([1, 2, 3, 4, 5, 6, 7, 6]).macd()", function() {
      it("should calculate the moving average convergence/divergence", function() {
  ...
  describe("TA([44.3389, 44.0902, 44.1497, 43.6124, 44.3278, 44.8264, 45.0955, 45.4245, 45.8433, 46.0826, 45.8931, 46.0328, 45.614, 46.282, 46.282, 46.0028, 46.0328, 46.4116, 46.2222, 45.6439]).rsi()", function() {
